...
console.log(loggedInUser._id)
  return (
    <div className="flex h-130 w-full items-center justify-center">
      {userDetails ? (
        <form className="relative h-100 w-2xl flex justify-between items-center px-10 shadow-md ring-1 ring-gray-200 p-4 bg-white rounded" onSubmit={handleSubmit}>
        <div className="w-1/2">
        ...
        {changeDetected && <button type="submit" className="px-2 py-1 bg-green-500 text-white font-semibold absolute left-1/2 transform -translate-x-1/2 bottom-3 rounded-md cursor-pointer">Update</button>}
      </form>
