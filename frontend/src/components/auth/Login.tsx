        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <form className="space-y-8" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              >
                ...
                <div className="group">
                  ...
                  <span className="absolute left-22 -top-10 mb-2 hidden group-hover:block bg-gray-800 text-white text-xs rounded py-1 px-2 z-10">
                    The password must contain a capital letter, small letter,
                    one digit and one special charatcter i.e. Dummy@123
                  </span>
                </div>
              </label>
              <div className="mt-1 relative">
              ...
              <div className="text-sm text-right mt-1 text-blue-600 cursor-pointer">Forgot Password?</div>
            </div>
            <div>
              <button
                type="submit"
            ...
            <div className={`flex justify-center w-full`}>
              <h4>New User?</h4>
              <Link to={"/register"} className="text-blue-600 pl-2 cursor-pointer">
                Register
              </Link>
            </div>
          </form>
