...
const CarLoanDetails: React.FC<LoanDetailsProps> = ({
  formData,
  onFormChange,
  formErrors,
}) => {
  ...
  const assetTypes = [
    ...
    },
    {
      value: "used-car-loan",
      label: "Used Car",
      icon: <FaCarBurst className="h-8 w-8" />,
    },
  ];
        ...
        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          <div className="sm:col-span-4">
            ...
            <div>
              ...
              <div className="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-3">
            ...
            {/* Car Brand and Model */}
            <div className="w-full gap-2 grid grid-cols-1 sm:grid-cols-2">
              <div className="mt-4">
                <label htmlFor="carBrandName">Car Brand</label>
                <div className="mt-2">
                  <input
                    id="carBrandName"
                    name="carBrandName"
                    type="text"
                    value={formData.carBrandName}
              ...
              <div className="mt-4">
                <label htmlFor="carModelName">Car Model</label>
                <div className="mt-2">
                  <input
                    id="carModelName"
                    name="carModelName"
